...
\includegraphics[width=0.9\textwidth]{Figure1-remastered.eps}
\caption{Пример вставки рисунка}
\end{figure}

\begin{figure}[h] \centering
	\includegraphics[width=0.9\textwidth]{Figure2-remastered.eps}
	\caption{Пример вставки рисунка}
\end{figure}
